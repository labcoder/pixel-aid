...
import {
  ...
  type EngineAssetRemovalResult
} from "@pixelaid/engine";

export type AssetLike = EngineAssetLike;
...
export type AssetRemovalResult<TAsset extends AssetLike> = EngineAssetRemovalResult<TAsset>;
...
export function removeAssetAndSelectNext<TAsset extends AssetLike>(
  ...
  return removeEngineAssetAndSelectNext(assets, removeId, selectedAssetId);
}
