...
Onboarding and release demo samples generated by `@pixelaid/fixtures` are first-party PixelAid sample assets authored by Mighty Games. They are deterministic synthetic test/demo materials and are safe to redistribute with PixelAid releases.
