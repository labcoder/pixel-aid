...
The next best implementation step is stronger real-sheet fixture coverage for labels, irregular gutters, and effect-heavy frames, followed by lightweight controls for correcting detected row names.
