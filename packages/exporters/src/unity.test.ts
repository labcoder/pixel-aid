...
describe("Unity import export adapter", () => {
  ...
  test("emits a Unity import recipe with known-good texture and sprite slicing settings", () => {
    const exportResult = createUnityImportExport(manifest);
    const recipe = exportResult.files.find((file) => file.path === "unity/import.recipe.json");
