...
Detection notes appear above the frame controls after Auto Suggest. They summarize frame and row counts, variable row lengths, and warnings such as outlined-cell detection or content-centered uneven-gutter normalization. Treat warnings as review prompts: the boxes are editable, and manual frame controls remain available.
